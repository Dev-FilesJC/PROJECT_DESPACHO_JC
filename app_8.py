...
.login-wrapper + div { max-width: 380px; margin-left: auto; margin-right: auto; }
</style>
""",
...
# =========================================================
# LOGIN - 4 USUARIOS DESDE STREAMLIT SECRETS
# =========================================================
...
def mostrar_login():
    st.markdown(
        ...
        <div class="login-wrapper">
            ...
            <div class="login-subtitle">Acceso al sistema de despacho</div>
        </div>
        """,
        unsafe_allow_html=True,
    )
    ...
    if len(usuarios) != 4:
        st.error(
            f"❌ Debes configurar exactamente 4 usuarios en Streamlit Secrets. "
            f"Actualmente hay {len(usuarios)}."
        )
        st.info("Usa el bloque [usuarios] con cuatro pares usuario = contraseña.")
        return
